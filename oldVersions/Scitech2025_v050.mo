model IDETC_v050
  ...
  CellStackTC_adapted stack2(RUL(fixed = true, start = 0.10), SOCini = 1, cellParameters = cellParams, np = 12, ns = 96)  annotation(
  ...
  Modelica.Blocks.Sources.Trapezoid trapezoid(amplitude = 2300*(3.14159/60), falling = 20, nperiod = -1, period = 6600, rising = 18.4, width = 1720)  annotation(
    Placement(visible = true, transformation(origin = {220, 374}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Logical.TerminateSimulation terminateSimulation(condition = stack2.RUL <= 0)  annotation(
    Placement(visible = true, transformation(origin = {92, 462}, extent = {{-40, -4}, {40, 4}}, rotation = 0)));
  Modelica.Blocks.Sources.Trapezoid trapezoid1(amplitude = 200*(3.14159/60), falling = 0, nperiod = -1, period = 6600, rising = 1.6, startTime = 18.4, width = 90)  annotation(
    Placement(visible = true, transformation(origin = {222, 318}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Modelica.Blocks.Math.Add add annotation(
    Placement(visible = true, transformation(origin = {174, 344}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Real totpower;
  parameter PowerSystems.AC3ph.Machines.Parameters.Synchron synPar annotation(
    Placement(visible = true, transformation(origin = {78, 300}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  ...
  connect(trapezoid.y, add.u1) annotation(
    Line(points = {{209, 374}, {200, 374}, {200, 350}, {186, 350}}, color = {0, 0, 127}));
  connect(trapezoid1.y, add.u2) annotation(
    Line(points = {{211, 318}, {200, 318}, {200, 338}, {186, 338}}, color = {0, 0, 127}));
  connect(loadsplitter.Bat1Load, load1.i) annotation(
    Line(points = {{-226, 380}, {-216, 380}, {-216, 402}, {-206, 402}}, color = {0, 0, 127}));
  connect(loadsplitter.Bat2Load, load2.i) annotation(
    Line(points = {{-226, 372}, {-216, 372}, {-216, 354}, {-206, 354}}, color = {0, 0, 127}));
