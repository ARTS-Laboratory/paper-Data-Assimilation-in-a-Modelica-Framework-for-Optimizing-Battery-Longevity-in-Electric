model SciTech_v070
  CellStackTC_adapted stack1(CycleLife = 425,RUL(fixed = true, start = 1), SOCini = 1, cellParameters = cellParams, np = 12, ns = 96)  annotation(
    Placement(transformation(origin = {-118, 404}, extent = {{10, -10}, {-10, 10}})));
  CellStackTC_adapted stack2(CycleLife = 425,RUL(fixed = true, start = 0.5), SOCini = 1, cellParameters = cellParams, np = 12, ns = 96)  annotation(
...
//  end if;
  ...
  annotation(
    ...
    Diagram(coordinateSystem(extent = {{-260, 460}, {20, -20}})),
